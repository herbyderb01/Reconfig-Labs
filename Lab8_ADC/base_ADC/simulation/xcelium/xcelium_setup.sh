...
# ----------------------------------------
# If base_ADC is one of several IP cores in your
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/nate/intelFPGA_lite/23.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_modular_adc_control.v"             -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_modular_adc_control_avrg_fifo.v"   -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_modular_adc_control_fsm.v"         -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/chsel_code_converter_sw_to_hw.v"          -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fiftyfivenm_adcblock_primitive_wrapper.v" -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fiftyfivenm_adcblock_top_wrapper.v"       -work control_internal -cdslib ./cds_libs/control_internal.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/base_ADC_modular_adc_0.vhd"               -work modular_adc_0    -cdslib ./cds_libs/modular_adc_0.cds.lib   
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/base_ADC.vhd"                                                                                                          
fi
